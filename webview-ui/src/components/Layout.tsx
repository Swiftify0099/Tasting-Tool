...
import {
  Home, Wrench, Code2, Play, History, Settings, Zap, ChevronRight, Sparkles, Crosshair, Monitor, Brain, FlaskConical
} from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { to: '/smart-tester', icon: FlaskConical, label: 'Smart Test', desc: 'No-API live tester' },
